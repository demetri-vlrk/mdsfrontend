    ...
    <div className="flex w-full flex-col items-start gap-6 border border-border px-8 py-10">
      <SectionHeader title="Product Setup">
        <button
          ...
          className="flex min-h-9 items-center justify-center rounded-lg px-4 py-2 text-muted-foreground hover:text-foreground"
        >
      ...
      <div className="flex w-full items-stretch">
        ...
        <div className="flex flex-1 flex-col items-stretch">
          <div className="flex flex-col items-start gap-6 border border-border p-6">
            ...
            <div className="flex w-full flex-col gap-2.5 text-sm text-muted-foreground">
        ...
        <div className="flex flex-1 flex-col items-stretch">
          <div className="flex flex-col items-start gap-6 border border-border p-6">
            ...
            <div className="flex min-h-9 w-full items-center gap-1 rounded-lg bg-input px-3 py-2 shadow-xs">
          ...
          <div className="flex flex-1 flex-col items-start border border-border">
            <div className="w-full p-6">
              <CardHeading icon={List} title="Categories">
                <Plus className="size-6 shrink-0 text-foreground" />
              </CardHeading>
            </div>
            <div className="flex w-full flex-col items-start">
              <div className="flex w-full items-center border-t border-border px-6 py-5 text-sm text-muted-foreground">
                Category 1
              </div>
              <div className="flex w-full items-center border-t border-border px-6 py-5 text-sm text-muted-foreground">
                Category 2
