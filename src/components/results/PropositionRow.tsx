...
export function PropositionRow() {
  return (
    <div className="flex w-full items-stretch px-8">
      <div className="relative flex flex-1 flex-col items-start justify-between border border-border p-6">
        <img
          src={propositionGlow}
          alt=""
          aria-hidden
        ...
        <div className="relative flex max-w-[410px] flex-col gap-1">
          ...
          <p className="max-w-[328px] text-sm font-medium text-muted-foreground">
        ...
        <div className="relative flex flex-col gap-3 p-3">
          ...
          <p className="text-7xl leading-none font-semibold tracking-[-1.5px] text-foreground">
            +22%
          </p>
