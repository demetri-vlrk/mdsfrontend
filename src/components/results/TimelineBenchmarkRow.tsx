...
export function TimelineBenchmarkRow() {
  return (
    <div className="flex w-full items-stretch px-8">
      <div className="flex w-[442px] shrink-0 flex-col gap-6 border border-border p-4">
          ...
          {TIMELINE.map((item, i) => (
            <div key={i} className="flex w-full flex-col gap-1">
              ...
              <div className="flex w-full items-start gap-2.5">
                <p className="flex-1 text-[17px] font-medium text-foreground">
                  {item.label}
                </p>
      ...
      <div className="flex flex-1 flex-col gap-4 border border-border p-4">
        <CardHeading icon={Package} title="Competitive Benchmark" />
        <div className="grid grid-cols-2 gap-2.5">
          {COMPETITORS.map((c, i) => (
            <div key={i} className="flex gap-4 bg-secondary p-4">
              <div className="flex w-[191px] shrink-0 flex-col justify-between gap-2.5">
                ...
                <div className="flex flex-col gap-1">
                  ...
                  <p className="text-4xl leading-none font-semibold tracking-[-1.5px] text-foreground">
                    {c.marketShare}
                  </p>
                </div>
              </div>
              <div className="flex flex-1 flex-col gap-2.5">
                <div className="flex flex-col gap-1">
                  ...
                  <p className="text-xs text-foreground">{c.keyAdvantage}</p>
                </div>
                <div className="flex flex-col gap-1">
                  <p className="text-xs text-muted-foreground">
                    Counter Stragety
